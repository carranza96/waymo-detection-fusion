...
class EnsembleModel(nn.Module):
    ...
    def forward_train(self,
        ...
        bbox_targets[0][order_inds] = bbox_targets[0]
        ...
        wandb.log({"loss_prev": loss_prev, "loss_new": loss_new})
...
torch.save(model.state_dict(), "ensemble_fixed2.pth")
